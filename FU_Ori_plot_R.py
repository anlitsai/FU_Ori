...
obj_name='FU Ori'
filter_ID=['R']
#list_data=['./slt_InstMag_Rmag/Rmag_FU_Ori_all.txt']
list_data=['./slt_InstMag_Rmag_VRIphot/Rmag_FU_Ori_all.txt']
filter_mag=['Rmag']
filter_err=['ErrorRmag']
...
plt.savefig('FU_Ori_plot_R.pdf') 
plt.savefig('FU_Ori_plot_R.png') 

print("... save file as FU_Ori_plot_R.pdf ...")
