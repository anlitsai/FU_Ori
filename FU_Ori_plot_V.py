...
list_data=['./slt_InstMag_Vmag_AAVSO/Vmag_FU_Ori_all.txt']
filter_mag=['Vmag']
filter_err=['ErrorVmag']
...
plt.savefig('FU_Ori_plot_V.pdf') 
plt.savefig('FU_Ori_plot_V.png') 

print("... save file as FU_Ori_plot_V.pdf ...")
