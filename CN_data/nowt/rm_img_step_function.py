...
imdata2=imdata[n_vertical_mid+1:,0:n_horizontal_mid]
plt.imshow(imdata2,vmin=value_min,vmax=value_max,cmap='viridis')
plt.title("imdata2")
plt.colorbar()
plt.show()

imdata3=imdata[0:n_vertical_mid,n_horizontal_mid+1:n_horizontal_end]
plt.imshow(imdata3,vmin=value_min,vmax=value_max,cmap='viridis')
plt.title("imdata3")
plt.colorbar()
plt.show()

imdata4=imdata[n_vertical_mid+1:,n_horizontal_mid+1:n_horizontal_end]
...
imdata[n_vertical_mid+1:,0:n_horizontal_mid]=imdata[n_vertical_mid+1:,0:n_horizontal_mid]-bkg_del[1]
imdata[0:n_vertical_mid,n_horizontal_mid+1:n_horizontal_end]=imdata[0:n_vertical_mid,n_horizontal_mid+1:n_horizontal_end]-bkg_del[2]
imdata[n_vertical_mid+1:,n_horizontal_mid+1:n_horizontal_end]=imdata[n_vertical_mid+1:,n_horizontal_mid+1:n_horizontal_end]-bkg_del[3]
