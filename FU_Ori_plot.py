...
obj_name='FU Ori'
filter_ID=['B','V','R']
list_data=['./slt_InstMag_Bmag_AAVSO_ACEI/Bmag_FU_Ori_all.txt','./slt_InstMag_Vmag_AAVSO_ACDEI/Vmag_FU_Ori_all.txt','./slt_InstMag_Rmag_VRIphot_ADEI/Rmag_FU_Ori_all.txt']
...
plt.savefig('FU_Ori_plot.pdf') 
plt.savefig('FU_Ori_plot.png') 

print("... save file as FU_Ori_plot.pdf ...")
