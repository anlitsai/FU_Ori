...
df_list_recommend['Bmag']=df_list_recommend['Bmag'].map('{:.3f}'.format)
df_list_recommend['Bmag_err']=df_list_recommend['Bmag_err'].map('{:.3f}'.format)
...
#file_list_out=dir_refstar+'slt_refStar_radec_annu.txt'
#file_list_out='slt_refStar_radec_annu_GuideStar.txt'
