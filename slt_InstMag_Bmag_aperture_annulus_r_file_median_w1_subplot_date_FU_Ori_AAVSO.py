...
dir_obj='slt_InstMag_'+filter_ID+'mag_AAVSO/'
...
#file_refstar='slt_refStar_radec_annu_AAVSO.txt'
#file_refstar='slt_refStar_radec_annu_AAVSO_ACDEI.txt'
file_refstar='slt_refStar_radec_annu_AAVSO_ACEI.txt'
